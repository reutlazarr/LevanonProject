...
def run_fold_script(bed_file_path, orig_site_dir):
    try:
        # Create output file path inside orig_site_dir
        output_file = os.path.join(orig_site_dir, "output_file.txt")
...
def run_on_directory(directory_path, orig_site_parent_dir):
    ...
    for bed_file in bed_files:
        ...
        # Run fold.py for each BED file
        run_fold_script(bed_file_path, orig_site_dir)
